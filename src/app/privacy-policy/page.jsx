...
const PrivacyPolicy = () => {
  return (
    <div className="container mx-auto px-4 max-w-6xl py-8">
      <h1 className="text-lg md:text-3xl md:text-5xl font-bold mb-4 text-black">Privacy Policy</h1>
      <p className="mb-4 text-base md:text-lg text-gray-700">
        Updated at December 24th, 2025
      </p>

      <p className="mb-4 text-base md:text-lg text-gray-700">
        Lynx (“we,” “our,” or “us”) is committed to protecting your privacy.
        This Privacy Policy explains how your personal information is collected,
        used, and disclosed by Lynx.
      </p>
      <p className="mb-4 text-base md:text-lg text-gray-700">
        This Privacy Policy applies to our app, and its associated subdomains
        (collectively, our “Service”) alongside our application, Lynx. By
      ...
      <ul className="list-disc pl-6 mb-4 text-base md:text-lg text-gray-700">
        ...
        <li>
          ...
          to use the Lynx Service to manage the relationships with your
        ...
        <li>
          Personnel: refers to those individuals who are employed by Lynx or are
      ...
      <ul className="list-disc pl-6 mb-4 text-base md:text-lg text-gray-700">
        ...
        <li>
          ...
          upload any picture straight from the platform, you can safely deny
          camera permissions for this platform.
        </li>
        <li>
          ...
          deny photo gallery access for this platform.
        </li>
      </ul>

      <h2 className="text-lg md:text-3xl font-semibold mb-2 text-black">
        When does Lynx use end user information from third parties?
      </h2>
      <p className="mb-4 text-base md:text-lg text-gray-700">
        Lynx will collect End User Data necessary to provide the Lynx services
        to our customers.
      </p>
      <p className="mb-4 text-base md:text-lg text-gray-700">
      ...
      <h2 className="text-lg md:text-3xl font-semibold mb-2 text-black">
        When does Lynx use customer information from third parties?
      </h2>
      <p className="mb-4 text-base md:text-lg text-gray-700">
        ...
        in becoming a Lynx customer, we receive information from a third party
        that provides automated fraud detection services to Lynx. We also
      ...
      <p className="mb-4 text-base md:text-lg text-gray-700">
        Lynx will collect personal information that you submit to us. We may
      ...
      <p className="mb-4 text-base md:text-lg text-gray-700">
        We keep your information only so long as we need it to provide Lynx to
      ...
      <p className="mb-4 text-base md:text-lg text-gray-700">
        ...
        any information you transmit to Lynx or guarantee that your information
      ...
      <p className="mb-4 text-base md:text-lg text-gray-700">
        Lynx is incorporated in United States. Information collected via our
        app, through direct interactions with you, or from use of our help
      ...
      <h2 className="text-lg md:text-3xl font-semibold mb-2 text-black">
        Is the information collected through the Lynx Service secure?
      </h2>
      <p className="mb-4 text-base md:text-lg text-gray-700">
      ...
      <p className="mb-4 text-base md:text-lg text-gray-700">
        ...
        Lynx collects depend on your relationship with Lynx. Personnel may
      ...
      <h2 className="text-lg md:text-3xl font-semibold mb-2 text-black">Personnel</h2>
      <p className="mb-4 text-base md:text-lg text-gray-700">
        If you are a Lynx worker or applicant, we collect information you
      ...
      <p className="mb-4 text-base md:text-lg text-gray-700">
        ...
        the assets of Lynx or any of its Corporate Affiliates (as defined
        herein), or that portion of Lynx or any of its Corporate Affiliates to
      ...
      <h2 className="text-lg md:text-3xl font-semibold mb-2 text-black">Affiliates</h2>
      <p className="mb-4 text-base md:text-lg text-gray-700">
        ...
        Lynx, whether by ownership or otherwise. Any information relating to you
      ...
      <h2 className="text-lg md:text-3xl font-semibold mb-2 text-black">Governing Law</h2>
      <p className="mb-4 text-base md:text-lg text-gray-700">
      ...
      <p className="mb-4 text-base md:text-lg text-gray-700">
        By using Lynx or contacting us directly, you signify your acceptance of
      ...
      <h2 className="text-lg md:text-3xl font-semibold mb-2 text-black">Your Consent</h2>
      <p className="mb-4 text-base md:text-lg text-gray-700">
        ...
        being used. By using our Lynx, registering an account, or making a
      ...
      <h2 className="text-lg md:text-3xl font-semibold mb-2 text-black">Cookies</h2>
      <p className="mb-4 text-base md:text-lg text-gray-700">
      ...
      <h2 className="text-lg md:text-3xl font-semibold mb-2 text-black">Kids' Privacy</h2>
      <p className="mb-4 text-base md:text-lg text-gray-700">
      ...
      <ul className="list-disc pl-6 mb-4 text-base md:text-lg text-gray-700">
        <li>
          Google Maps API Google Maps API is a robust tool that can be used to
          create a custom map, a searchable map, check-in functions, display
          live data synching with location, plan routes, or create a mashup just
          to name a few. Google Maps API may collect information from You and
          from Your Device for security purposes. Google Maps API collects
          information that is held in accordance with its Privacy Policy
        </li>
        <li>
          Local Storage Local Storage sometimes known as DOM storage, provides
          web apps with methods and protocols for storing client-side data. Web
          storage supports persistent data storage, similar to cookies but with
          a greatly enhanced capacity and no information stored in the HTTP
          request header.
        </li>
        <li>
          Sessions We use "Sessions" to identify the areas of our platform that
          you have visited. A Session is a small piece of data stored on your
      ...
      <h2 className="text-lg md:text-3xl font-semibold mb-2 text-black">What is GDPR?</h2>
      <p className="mb-4 text-base md:text-lg text-gray-700">
      ...
      <p className="mb-4 text-base md:text-lg text-gray-700">
        ...
        At Lynx we strongly believe that your data privacy is very important and
      ...
      <p className="mb-4 text-base md:text-lg text-gray-700">
        ...
        requirements of GDPR. Lynx processes or stores all personal data in
      ...
      <h2 className="text-lg md:text-3xl font-semibold mb-2 text-black">Contact Us</h2>
      <p className="mb-4 text-base md:text-lg text-gray-700">
      ...
      <ul className="list-disc pl-6 mb-4 text-base md:text-lg text-gray-700">
        ...
        <li>Via Address: 8 THE Green STE B Dover, DE 19901</li>
      </ul>
    </div>
  );
};
