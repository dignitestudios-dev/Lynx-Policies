...
const TermsAndConditions = () => {
  return (
    <div className="container mx-auto px-4 max-w-6xl py-8">
      <h1 className="text-5xl font-bold mb-4 text-black">Terms & Conditions</h1>
      <p className="mb-4 text-lg text-gray-700">
        Updated at December 24th, 2025
      </p>

      <h2 className="text-3xl font-semibold mb-2 text-black">General Terms</h2>
      <p className="mb-4 text-lg text-gray-700">
      ...
      <h2 className="text-3xl font-semibold mb-2 text-black">License</h2>
      <p className="mb-4 text-lg text-gray-700">
      ...
      <h2 className="text-3xl font-semibold mb-2 text-black">Restrictions</h2>
      <p className="mb-4 text-lg text-gray-700">
      ...
      <h2 className="text-3xl font-semibold mb-2 text-black">Payment</h2>
      <p className="mb-4 text-lg text-gray-700">
      ...
      <h2 className="text-3xl font-semibold mb-2 text-black">Your Consent</h2>
      <p className="mb-4 text-lg text-gray-700">
      ...
      <h2 className="text-3xl font-semibold mb-2 text-black">Cookies</h2>
      <p className="mb-4 text-lg text-gray-700">
      ...
      <h2 className="text-3xl font-semibold mb-2 text-black">No Warranties</h2>
      <p className="mb-4 text-lg text-gray-700">
      ...
      <h2 className="text-3xl font-semibold mb-2 text-black">Severability</h2>
      <p className="mb-4 text-lg text-gray-700">
      ...
      <h2 className="text-3xl font-semibold mb-2 text-black">Waiver</h2>
      <p className="mb-4 text-lg text-gray-700">
      ...
      <h2 className="text-3xl font-semibold mb-2 text-black">Promotions</h2>
      <p className="mb-4 text-lg text-gray-700">
      ...
      <h2 className="text-3xl font-semibold mb-2 text-black">Miscellaneous</h2>
      <p className="mb-4 text-lg text-gray-700">
      ...
      <h2 className="text-3xl font-semibold mb-2 text-black">Disclaimer</h2>
      <p className="mb-4 text-lg text-gray-700">
      ...
      <h2 className="text-3xl font-semibold mb-2 text-black">Contact Us</h2>
      <p className="mb-4 text-lg text-gray-700">
