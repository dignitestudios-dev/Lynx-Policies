...
const TermsAndConditions = () => {
  return (
    <div className="container mx-auto px-4 max-w-6xl py-8">
      ...
      <h2 className="text-xl md:text-3xl font-semibold mb-2 text-black">General Terms</h2>
      <p className="mb-4 text-base md:text-lg text-gray-700">
        By accessing and placing an order with Lynx, you confirm that you are in
        ...
        any email or other type of communication between you and Lynx.
      </p>
      <p className="mb-4 text-base md:text-lg text-gray-700">
        Under no circumstances shall Lynx team be liable for any direct,
        ...
        inability to use, the materials on this site, even if Lynx team or an
      ...
      <p className="mb-4 text-base md:text-lg text-gray-700">
        Lynx will not be responsible for any outcome that may occur during the
      ...
      <h2 className="text-xl md:text-3xl font-semibold mb-2 text-black">License</h2>
      <p className="mb-4 text-base md:text-lg text-gray-700">
        Lynx grants you a revocable, non-exclusive, non-transferable, limited
        license to download, install and use the app strictly in accordance with
        the terms of this Agreement.
      </p>
      <p className="mb-4 text-base md:text-lg text-gray-700">
        These Terms & Conditions are a contract between you and Lynx (referred
        to in these Terms & Conditions as "Lynx", "us", "we" or "our"), the
        provider of the Lynx website and the services accessible from the Lynx
      ...
      <p className="mb-4 text-base md:text-lg text-gray-700">
        ...
        agree to these Terms & Conditions, please do not use the Lynx Service.
      ...
      <ul className="list-disc pl-6 mb-4 text-base md:text-lg text-gray-700">
        ...
        <li>
          ...
          refers to EGAC GROUP LLC, (8 THE Green STE B Dover, DE 19901), that is
          responsible for your information under this Terms & Conditions.
        </li>
        <li>
          Country: where Lynx or the owners/founders of Lynx are based, in this
          case is United States
        </li>
        <li>
          Device: any internet connected device such as a phone, tablet,
          computer or any other device that can be used to visit Lynx and use
          the services.
        </li>
        <li>
          Service: refers to the service provided by Lynx as described in the
        ...
        <li>
          App/Application: Lynx app, refers to the SOFTWARE PRODUCT identified
          above.
        </li>
        <li>
          You: a person or entity that is registered with Lynx to use the
          Services.
        </li>
      </ul>

      <h2 className="text-xl md:text-3xl font-semibold mb-2 text-black">Restrictions</h2>
      <p className="mb-4 text-base md:text-lg text-gray-700">
      ...
      <ul className="list-disc pl-6 mb-4 text-base md:text-lg text-gray-700">
        ...
        <li>
          ...
          of copyright or trademark) of Lynx or its affiliates, partners,
          suppliers or the licensors of the app.
        </li>
      </ul>

      <h2 className="text-xl md:text-3xl font-semibold mb-2 text-black">Payment</h2>
      <p className="mb-4 text-base md:text-lg text-gray-700">
        ...
        agreement and not these Terms to determine your rights and liabilities
        with respect to your Payment Provider. By providing Lynx with your
        credit card number and associated payment information, you agree that
        Lynx is authorized to verify information immediately, and subsequently
        invoice your account for all fees and charges due and payable to Lynx
        hereunder and that no additional notice or consent is required. You
        agree to immediately notify Lynx of any change in your billing address
        or the credit card used for payment hereunder. Lynx reserves the right
        at any time to change its prices and billing methods, either immediately
        upon posting on our Site or by e-mail delivery to your organization’s
        administrator(s).
      </p>
      <p className="mb-4 text-base md:text-lg text-gray-700">
      ...
      <p className="mb-4 text-base md:text-lg text-gray-700">
        No contract will exist between you and Lynx for the Service until Lynx
        accepts your order by a confirmatory e-mail, SMS/MMS message, or other
      ...
      <p className="mb-4 text-base md:text-lg text-gray-700">
        Thanks for shopping at Lynx. We appreciate the fact that you like to buy
      ...
      <p className="mb-4 text-base md:text-lg text-gray-700">
        ...
        apply to transactions at Lynx. We’ll be as brief as our attorneys will
        allow. The main thing to remember is that by placing an order or making
        a purchase at Lynx, you agree to the terms along with Lynx’s Privacy
        Policy.
      </p>
      <p className="mb-4 text-base md:text-lg text-gray-700">
      ...
      <p className="mb-4 text-base md:text-lg text-gray-700">
        ...
        (collectively, "Suggestions") provided by you to Lynx with respect to
        the app shall remain the sole and exclusive property of Lynx.
      </p>
      <p className="mb-4 text-base md:text-lg text-gray-700">
        Lynx shall be free to use, copy, modify, publish, or redistribute the
        Suggestions for any purpose and in any way without any credit or any
        compensation to you.
      </p>

      <h2 className="text-xl md:text-3xl font-semibold mb-2 text-black">Your Consent</h2>
      <p className="mb-4 text-base md:text-lg text-gray-700">
      ...
      <p className="mb-4 text-base md:text-lg text-gray-700">
        ...
        contain links to other websites not operated or controlled by Lynx. We
      ...
      <h2 className="text-xl md:text-3xl font-semibold mb-2 text-black">Cookies</h2>
      <p className="mb-4 text-base md:text-lg text-gray-700">
        Lynx uses "Cookies" to identify the areas of our app that you have
      ...
      <p className="mb-4 text-base md:text-lg text-gray-700">
        You acknowledge and agree that Lynx may stop (permanently or
        temporarily) providing the Service (or any features within the Service)
        to you or to users generally at Lynx’s sole discretion, without prior
        notice to you. You may stop using the Service at any time. You do not
        need to specifically inform Lynx when you stop using the Service. You
        acknowledge and agree that if Lynx disables access to your account, you
      ...
      <p className="mb-4 text-base md:text-lg text-gray-700">
        Lynx reserves the right to modify, suspend or discontinue, temporarily
      ...
      <p className="mb-4 text-base md:text-lg text-gray-700">
        Lynx may from time to time provide enhancements or improvements to the
      ...
      <p className="mb-4 text-base md:text-lg text-gray-700">
        ...
        the app. You agree that Lynx has no obligation to (i) provide any
      ...
      <p className="mb-4 text-base md:text-lg text-gray-700">
        You acknowledge and agree that Lynx shall not be responsible for any
        ...
        or any other aspect thereof. Lynx does not assume and shall not have any
      ...
      <p className="mb-4 text-base md:text-lg text-gray-700">
        This Agreement shall remain in effect until terminated by you or Lynx.
      </p>
      <p className="mb-4 text-base md:text-lg text-gray-700">
        Lynx may, in its sole discretion, at any time and for any or no reason,
      ...
      <p className="mb-4 text-base md:text-lg text-gray-700">
        ...
        Lynx, in the event that you fail to comply with any provision of this
        Agreement. You may also terminate this Agreement by deleting the app and
      ...
      <p className="mb-4 text-base md:text-lg text-gray-700">
        Termination of this Agreement will not limit any of Lynx's rights or
      ...
      <p className="mb-4 text-base md:text-lg text-gray-700">
        You agree to indemnify and hold Lynx and its parents, subsidiaries,
      ...
      <h2 className="text-xl md:text-3xl font-semibold mb-2 text-black">No Warranties</h2>
      <p className="mb-4 text-base md:text-lg text-gray-700">
        The app is provided to you "AS IS" and "AS AVAILABLE" and with all
        faults and defects without warranty of any kind. To the maximum extent
        permitted under applicable law, Lynx, on its own behalf and on behalf of
        ...
        limitation to the foregoing, Lynx provides no warranty or undertaking,
        and makes no representation of any kind that the app will meet your
        requirements, achieve any intended results, be compatible or work with
        any other software, apps, systems or services, operate without
      ...
      <p className="mb-4 text-base md:text-lg text-gray-700">
        Without limiting the foregoing, neither Lynx nor any Lynx's provider
        makes any representation or warranty of any kind, express or implied:
        (i) as to the operation or availability of the app, or the information,
        content, and materials or products included thereon; (ii) that the app
        ...
        the app; or (iv) that the app, its servers, the content, or e-mails sent
        from or on behalf of Lynx are free of viruses, scripts, trojan horses,
      ...
      <p className="mb-4 text-base md:text-lg text-gray-700">
        ...
        of Lynx and any of its suppliers under any provision of this Agreement
      ...
      <p className="mb-4 text-base md:text-lg text-gray-700">
        ...
        Lynx or its suppliers be liable for any special, incidental, indirect,
        ...
        out of or in any way related to the use of or inability to use the app,
        third-party software and/or third-party hardware used with the app, or
        otherwise in connection with any provision of this Agreement), even if
        Lynx or any supplier has been advised of the possibility of such damages
      ...
      <h2 className="text-xl md:text-3xl font-semibold mb-2 text-black">Severability</h2>
      <p className="mb-4 text-base md:text-lg text-gray-700">
      ...
      <p className="mb-4 text-base md:text-lg text-gray-700">
        ...
        notices published by Lynx on the Services, shall constitute the entire
        agreement between you and Lynx concerning the Services. If any provision
        ...
        term, and Lynx’s failure to assert any right or provision under this
        Agreement shall not constitute a waiver of such right or provision. YOU
        AND Lynx AGREE THAT ANY CAUSE OF ACTION ARISING OUT OF OR RELATED TO THE
      ...
      <h2 className="text-xl md:text-3xl font-semibold mb-2 text-black">Waiver</h2>
      <p className="mb-4 text-base md:text-lg text-gray-700">
      ...
      <p className="mb-4 text-base md:text-lg text-gray-700">
        Lynx reserves the right, at its sole discretion, to modify or replace
      ...
      <p className="mb-4 text-base md:text-lg text-gray-700">
        ...
        agree to the new terms, you are no longer authorized to use Lynx.
      </p>
      ...
      <p className="mb-4 text-base md:text-lg text-gray-700">
        The Agreement constitutes the entire agreement between you and Lynx
        regarding your use of the app and supersedes all prior and
        contemporaneous written or oral agreements between you and Lynx.
      </p>
      <p className="mb-4 text-base md:text-lg text-gray-700">
        You may be subject to additional terms and conditions that apply when
        you use or purchase other Lynx's services, which Lynx will provide to
      ...
      <p className="mb-4 text-base md:text-lg text-gray-700">
        ...
        owned by Lynx, its licensors or other providers of such material and are
        ...
        express prior written permission of Lynx, unless and except as is
      ...
      <p className="mb-4 text-base md:text-lg text-gray-700">
        ...
        ENFORCEMENT OR VALIDITY OF YOUR OR Lynx’s INTELLECTUAL PROPERTY RIGHTS.
        The term “dispute” means any dispute, action, or other controversy
        between you and Lynx concerning the Services or this agreement, whether
      ...
      <p className="mb-4 text-base md:text-lg text-gray-700">
        In the event of a dispute, you or Lynx must give the other a Notice of
        ...
        <a href="mailto:info@lynxuni.com">info@lynxuni.com</a>. Lynx will send
        any Notice of Dispute to you by mail to your address if we have it, or
        otherwise to your email address. You and Lynx will attempt to resolve
        any dispute through informal negotiation within sixty (60) days from the
        date the Notice of Dispute is sent. After sixty (60) days, you or Lynx
      ...
      <p className="mb-4 text-base md:text-lg text-gray-700">
        If you and Lynx don’t resolve any dispute by informal negotiation, any
      ...
      <p className="mb-4 text-base md:text-lg text-gray-700">
        ...
        and will become the sole property of Lynx without any compensation or
        credit to you whatsoever. Lynx and its affiliates shall have no
      ...
      <h2 className="text-xl md:text-3xl font-semibold mb-2 text-black">Promotions</h2>
      <p className="mb-4 text-base md:text-lg text-gray-700">
        Lynx may, from time to time, include contests, promotions, sweepstakes,
        or other activities (“Promotions”) that require you to submit material
        or information concerning yourself. Please note that all Promotions may
        be governed by separate rules that may contain certain eligibility
      ...
      <h2 className="text-xl md:text-3xl font-semibold mb-2 text-black">Miscellaneous</h2>
      <p className="mb-4 text-base md:text-lg text-gray-700">
        ...
        of Lynx. Lynx will be entitled to injunctive or other equitable relief
        (without the obligations of posting any bond or surety) in the event of
        any breach or anticipatory breach by you. Lynx operates and controls the
        Lynx Service from its offices in United States. The Service is not
        ...
        the Lynx Service from other locations do so on their own initiative and
        ...
        include and incorporate the Lynx Privacy Policy) contains the entire
        understanding, and supersedes all prior understandings, between you and
        Lynx concerning its subject matter, and cannot be changed or modified by
        you. The section headings used in this Agreement are for convenience
        only and will not be given any legal import.
      </p>

      <h2 className="text-xl md:text-3xl font-semibold mb-2 text-black">Disclaimer</h2>
      <p className="mb-4 text-base md:text-lg text-gray-700">
        Lynx is not responsible for any content, code or any other imprecision.
      </p>
      <p className="mb-4 text-base md:text-lg text-gray-700">
        Lynx does not provide warranties or guarantees.
      </p>
      <p className="mb-4 text-base md:text-lg text-gray-700">
        In no event shall Lynx be liable for any special, direct, indirect,
      ...
      <p className="mb-4 text-base md:text-lg text-gray-700">
        The Lynx Service and its contents are provided "as is" and "as
        available" without any warranty or representations of any kind, whether
        express or implied. Lynx is a distributor and not a publisher of the
        content supplied by third parties; as such, Lynx exercises no editorial
        ...
        service or merchandise provided through or accessible via the Lynx
        Service. Without limiting the foregoing, Lynx specifically disclaims all
        warranties and representations in any content transmitted on or in
        connection with the Lynx Service or on sites that may appear as links on
        the Lynx Service, or in the products provided as a part of, or otherwise
        in connection with, the Lynx Service, including without limitation any
        warranties of merchantability, fitness for a particular purpose or
        non-infringement of third party rights. No oral advice or written
        information given by Lynx or any of its affiliates, employees, officers,
        ...
        limiting the foregoing, Lynx does not warrant that the Lynx Service will
        be uninterrupted, uncorrupted, timely, or error-free.
      </p>

      <h2 className="text-xl md:text-3xl font-semibold mb-2 text-black">Contact Us</h2>
      <p className="mb-4 text-base md:text-lg text-gray-700">
        Don't hesitate to contact us if you have any questions.
      </p>
      <ul className="list-disc pl-6 mb-4 text-base md:text-lg text-gray-700">
        <li>
          Via Email: <a href="mailto:info@lynxuni.com">info@lynxuni.com</a>
        </li>
        <li>Via Phone number: +1 857 400 4600</li>
        <li>
          Via this Link: <a href="https://lynxuni.com/">https://lynxuni.com/</a>
        </li>
        <li>Via this Address: 8 THE Green STE B Dover, DE 19901</li>
      </ul>
    </div>
  );
};
